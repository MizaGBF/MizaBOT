...
class GBF_Game(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.scratcher_loot = {
            ...
            10000 : ['Crystals x3000', 'Intricacy Ring', 'Gold Spellbook', 'Moonlight Stone', 'Gold Moon x2', 'Ultima Unit x3', 'Silver Centrum x5', 'Primeval Horn x3', 'Horn of Bahamut x4', 'Legendary Merit x5', 'Steel Brick', 'Brimston Earrings', 'Permafrost Earrings', 'Brickearth Earrings', 'Jetstream Earrings', 'Sunbeam Earrings', 'Nightshade Earrings'],
