...
class Mizabot(commands.Bot):
    def __init__(self):
        ...
        self.botchangelog = ["Added back `$mizatube` (no fancy search function)", "Removed `$summon`", "Added `$blackjack`", "Added `$recruit` to check recruiting /gbfg/ crews"] # bot changelog
