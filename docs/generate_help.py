...
As a result, slots 91 to 100 will be reserved for my personal use.<br>
...
Finally, <b>make sure the bot can access those channels</b>. It only needs the read permission for the tracked channels but it <b>needs</b> the send message permission to post in the output one.<br>
<br>
...
Finally, /mod pinboard see lets you see your current server pinboard settings.<br>
<br>
Pinning a message is then easy: People must react to the message with the corresponding emoji.<br>
<b>Once it meets the required amount of reactions you set</b>, someone must go under the Apps menu of the message and click on Pin message.<br>
<img src="img/guide_pinboard.png"></p>
...
<p>Errors are usually automatically reported but, if you found an odd behavior or what seems like an error, you can use the /bug_report command.</p>
...
<p>Your linked GBF ID can be removed with the /gbf profile unset command.
