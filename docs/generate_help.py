...
Finally, I don't recommend tweaking the invite link permissions. If you had more roles to the bot, make sure those roles don't disable permissions that the bot needs.</p>
